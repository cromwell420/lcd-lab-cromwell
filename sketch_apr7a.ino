...
void reactionGame() {
  ...
  unsigned long Delay = random(3000, 6000);
  delay(Delay);

  lcd.clear();                 
  lcd.print("NOWWw");  // Ask the player to press the button as fast as possible
  ...
  delay(3000); 
} // Keep the result displayed for 3 seconds before restarting
